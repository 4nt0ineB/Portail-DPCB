                    ...
                    <div class="row">
                        <div class="col">
                            <div class="skills portfolio-info-card">
                                ...
                                <p class="text-uppercase text-center text-success border-success" data-toggle="tooltip"
                                    data-bs-tooltip="" title="Votre solde en ce jour"
                                    style="font-size: 40px;text-shadow: 0px 0px 4px rgb(150,150,150);">+300,00€</p>
                                <p class="text-center" style="height: 23px;margin-top: -24px;font-size: 14px;"><em>Votre
                                        solde actuel</em><br></p>
                                <div class="row">
                                    <div class="col" style="text-align: center;">
                                        <div class="btn-group open" style="border-style: none;"><button
                                                class="btn btn-primary" type="button"
                                                style="background: rgb(255,255,255);color: rgb(0,0,0);border: 1px solid rgb(0,0,0) ;">Actions</button><button
                                ...
                                <h1
                                    style="font-size: 20px;border-width: 1px;border-style: none;border-bottom-style: dotted;">
                                    Vos dernières transactions</h1>
                                <div class="row">
                                    <div class="skills portfolio-info-card"
                                        style="width: 100%;margin-bottom: 15px;padding: 25px;">
                                        <p class="text-uppercase text-left text-dark" data-toggle="tooltip"
                                            data-bs-tooltip=""
                                            style="margin: 0;text-align: left;font-weight: bold;width: 80%;float: left;"
                                            title="Organisme"><span style="text-decoration: underline;">CRÉDIT AGRICOLE
                                                SEPA 84415641896748</span></p><span class="text-right text-success"
                                            style="width: 20%;float: right;">+300,00€</span>
                                    </div>
                                    <div class="skills portfolio-info-card"
                                        style="width: 100%;padding: 25px;margin-bottom: 15px;">
                                        <p class="text-uppercase text-left text-dark" data-toggle="tooltip"
                                            data-bs-tooltip=""
                                            style="margin: 0;text-align: left;font-weight: bold;width: 80%;float: left;"
                                            title="Organisme"><span style="text-decoration: underline;">INTérets année
                                                2020</span></p><span class="text-right text-danger"
                                            style="width: 20%;float: right;">+0,00€</span>
                                    </div>
                                </div>
                            </div>
                        </div>
