...
<body>
    ...
    <main class="page cv-page">
        <section class="portfolio-block cv">
            ...
            ?>
                <h2 class="text-center">Tous les impayés<span style="color: #7C71F5;">

                    <?php
                } else {

                    ?>
                        <h2 class="text-center">Impayés de <span style="color: #7C71F5;">
                            <?php
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="skills portfolio-info-card">
                                            ...
                                            $no_debut = "0000-01-01";
                                            if (($_SESSION["permission"] == "2" && isset($_GET["all"]))) {
                                                $requete = "SELECT * FROM `IMPAYE` i JOIN DEVISE ON i.id_devise = DEVISE.id_devise, (SELECT * FROM `REMISE`)  r  WHERE r.id_remise = i.id_remise";
                                            } else {
