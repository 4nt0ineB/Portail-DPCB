...
define("REMOTE_REPOSITORY", "git@github.com:cydaw6/Portail-DPCB.git"); // The SSH URL to your repository
define("DIR", "/var/www/portail-dpcb");                          // The path to your repostiroy; this must begin with a forward slash (/)
